...
@Component({
  selector: 'app-comments-employee',
  templateUrl: './comments-employee.component.html',
  styleUrls: ['./comments-employee.component.scss']
})
export class CommentsEmployeeComponent implements OnInit {
